...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radio_show_image = QtWidgets.QRadioButton(self.centralwidget)
        self.radio_show_image.setObjectName("radio_show_image")
        self.verticalLayout_4.addWidget(self.radio_show_image)
        self.radio_show_surface_2D = QtWidgets.QRadioButton(self.centralwidget)
        self.radio_show_surface_2D.setObjectName("radio_show_surface_2D")
        self.verticalLayout_4.addWidget(self.radio_show_surface_2D)
        self.radio_show_surface_3D = QtWidgets.QRadioButton(self.centralwidget)
        self.radio_show_surface_3D.setObjectName("radio_show_surface_3D")
        self.verticalLayout_4.addWidget(self.radio_show_surface_3D)
        ...
        self.horizontalLayout_7.addWidget(self.label_frame_count)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio_show_image.setText(_translate("MainWindow", "Image"))
        self.radio_show_surface_2D.setText(_translate("MainWindow", "Surface 2D"))
        self.radio_show_surface_3D.setText(_translate("MainWindow", "Surface 3D"))
